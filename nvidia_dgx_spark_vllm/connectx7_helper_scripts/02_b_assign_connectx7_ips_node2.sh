#!/bin/bash
# =============================================================================
# 02_b_assign_connectx7_ips_node2.sh
# Assign ConnectX-7 IPs on spark02
# =============================================================================
# IP assignments:
#   enp1s0f0np0  → 10.0.1.2/24  (Cable 1 — Port 1)
#   enP2p1s0f0np0 → 10.0.2.2/24  (Cable 2 — Port 2)
#
# Usage:
#   sudo ./02_b_assign_connectx7_ips_node2.sh
# =============================================================================

NODE_NAME="spark02"
PORT1_IFACE="enp1s0f0np0"
PORT1_IP="10.0.1.2/24"
PORT2_IFACE="enP2p1s0f0np0"
PORT2_IP="10.0.2.2/24"
